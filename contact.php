		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-md-2">
							<div id="colorlib-logo"><a href="index.php">SJC.</a></div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="contact-info-wrap-flex">
									<div class="con-info">
										<p><span><i class="icon-location-2"></i></span> Palm Beach, Broward & Dade Counties <br> Florida</p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-phone3"></i></span> <a target="_self" href="tel:+15616333994">561.633.3994</a></p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-paperplane"></i></span> <a href="mailto:Sjc.multimediadesign@gmail.com" target="_top">Sjc.multimediadesign@gmail.com</a></p>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- <div class="col-md-8 col-md-pull-4 animate-box">
						...
						<form name="contactform" action="contact-form.php" method="post">
							<div class="row form-group">
								<div class="col-md-12">
									<input type="text" id="name" class="form-control" placeholder="Your first & last name">
								</div>
